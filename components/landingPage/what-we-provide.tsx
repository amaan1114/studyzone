...
export function WhatWeProvide() {
  return (
    <section className="relative overflow-hidden bg-white dark:bg-slate-900 py-20 sm:py-24">
      <div
        aria-hidden
        className="pointer-events-none absolute -left-24 top-12 h-80 w-80 rounded-full bg-pink-100/60 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-purple-100/45 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-pink-200 to-transparent"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mx-auto mb-5 h-1.5 w-20 rounded-full bg-[#f33255]" />
        ...
        >
          <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
            <div className="border-b border-slate-200 dark:border-slate-700 px-8 py-8 sm:px-10 lg:border-b-0 lg:border-r bg-linear-to-br from-pink-50/60 to-white dark:from-pink-950/20 dark:to-slate-800">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="rounded-full border border-pink-100 dark:border-pink-800/40 bg-white dark:bg-slate-700 px-3 py-1 text-xs font-medium text-[#201657] dark:text-white"
                  >
                    {tag}
                  </span>
                ))}
              </div>
              <div className="mt-8 h-px w-full bg-linear-to-r from-pink-200 via-slate-100 to-transparent dark:from-pink-800/40 dark:via-slate-700 dark:to-transparent" />
              ...
              {items.map((item, index) => (
                ...
                >
                  <div className="flex items-start gap-5">
                      <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl border border-pink-100 dark:border-pink-800/40 bg-pink-50 dark:bg-pink-950/30 text-[#f33255] transition-transform duration-200 group-hover:scale-[1.03]">
                      <item.icon className="size-6" />
                    </div>

                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-3">
                          <span className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#f33255]">
                          0{index + 1}
                        </span>
